      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        ...
        <div className="space-y-6">
          ...
          <motion.article
            ...
            className="rounded-lg border border-ink-500 bg-ink-700 p-6 transition-colors hover:border-mint-400/40 sm:p-8">
              ...
              <div className="mt-6 grid gap-8 lg:grid-cols-[1fr_1.4fr]">
                <div className="space-y-6">
                  <div>
                    <h4 className="font-mono text-[11px] uppercase tracking-widest text-mint-400">
                      Problem
                    </h4>
        ...
        <p className="mt-8 font-mono text-xs text-slateish-500">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-mint-400 underline underline-offset-4">
